...
exports.run = (client, message, args) => {
   ...
   .addField('k!havadurumu il', 'Havadurumunu öğrenirsiniz')
     .addField('k!davet', 'Davet linkleri')
     .addField('k!ping', 'Botun pingini gösterir')
     .addField('k!i', 'Botun istatistikleri')//ne kadar Ekstra komutunuz varsa o kadar .addField('prefix+komut', 'açıklama/kullanım amacı') koyun
