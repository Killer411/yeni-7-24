...
exports.run = (client, message, args) => {
    ...
    .addField('k!gir', 'Bot bulunduğunuz odaya girer.')
    .addField('k!çal MÜZİK', 'Müzik başlatır.')
     .addField('k!durdur', 'Müziği durdurur.')
     .addField('k!geç', 'Müziği geçersiniz.')//ne kadar Ekstra komutunuz varsa o kadar .addField('prefix+komut', 'açıklama/kullanım amacı') koyun
